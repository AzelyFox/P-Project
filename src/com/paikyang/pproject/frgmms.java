...
public class frgmms extends Fragment {
	Context mContext;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		Log.v("frg_mms", "create");
		View view = inflater.inflate(R.layout.frg_mms, null);
...
//		rss.threadRssParse(getActivity(), sa, list_board, "http://www.filenanumi.com/rss");
		...
		btn_next.setOnClickListener(new OnClickListener() {
				@Override
				public void onClick(final View v) {
					((com.paikyang.pproject.MainActivity)getActivity()).setCurrentPagerItem(5);
